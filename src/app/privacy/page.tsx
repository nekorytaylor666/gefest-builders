...
const PrivacyPage = () => {
  return (
    <div className="container my-12 prose">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Gefest Builder.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Gefest Builder, accessible from{" "}
            <a
              href="https://www.gefest.dev/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.gefest.dev/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: akmt.me23@gmail.com</li>
      </ul>
    </div>
  );
};
